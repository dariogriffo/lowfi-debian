...
📖 **Step-by-step install guide:** [Debian](https://debian.griffo.io/install-latest-lowfi-in-debian.html) · [Ubuntu](https://debian.griffo.io/install-latest-lowfi-in-ubuntu.html)
